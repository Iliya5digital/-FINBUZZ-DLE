...
<div class="form-group">
<a href="#" class="sec-btn2 btn-block" onclick="$('.addvote').toggle();return false;"><span class="plus_icon circle"><span>+</span></span> Добавить Опрос</a>
</div>
...
<button class="sec-btn" type="submit" name="add">Отправить</button>
<button class="sec-btn2" onclick="preview()" type="submit" name="nview">Предпросмотр</button>
